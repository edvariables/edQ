	...
	DataTable = function( options )
	{
		...
		this.each(function() {
			...
			if ( oInit.oLanguage.sUrl !== "" )
			{
				 ...
				 */
				/* ED140914 : avoids reload */
				bInitHandedOff = true;
				if (DataTable.oLanguageUrl == oInit.oLanguage.sUrl) {
					oSettings.oLanguage = DataTable.oLanguage;
					...
					$.getJSON( oSettings.oLanguage.sUrl, null, function( json ) {
						...
						/* ED140914 : avoid reload */
						DataTable.oLanguageUrl = oSettings.oLanguage.sUrl;
						DataTable.oLanguage = $.extend( true, oSettings.oLanguage, oInit.oLanguage, json );
