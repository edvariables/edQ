...
class ASNAvisASN extends ASNabstract {

    protected $url = 'http://www.asn.fr/Reglementer/Bulletin-officiel-de-l-ASN/Avis-de-l-ASN';
    ...
    protected function alimenterInfos($url) {
        ...
        foreach ($this->html->find('div[class=view resume]') as $ligneInfo) {
            ...
            $item['texte'] = trim(str_replace($libelleInstallation, '', $item['texte']));
            $item['texte'] = trim(str_replace($publieLe, '', $item['texte']));
            //
